...
return "100%";},},{key:"getQueryString",value:function getQueryString(obj){var url="";Object.keys(obj).forEach(function(key){url+=key+"="+obj[key]+"&";});return url.substr(0,url.length-1);},},{key:"getVideoUrl",value:function getVideoUrl(opt,channel,videoId){if(channel==="youtube"){return this.getYoutubeUrl(opt.youtube,videoId);}else if(channel==="vimeo"){return this.getVimeoUrl(opt.vimeo,videoId);}else if(channel==="facebook"){return this.getFacebookUrl(opt.facebook,videoId);}else if(channel==="custom"){return opt.url;}
return "";},},{key:"getVimeoUrl",value:function getVimeoUrl(vimeo,videoId){var query=this.getQueryString(vimeo);return "//player.vimeo.com/video/"+videoId+"?"+query;},},{key:"getYoutubeUrl",value:function getYoutubeUrl(youtube,videoId){var query=this.getQueryString(youtube);if(youtube.nocookie===true){return("//www.youtube-nocookie.com/embed/"+
videoId+
"?"+
query);}
return "//www.youtube.com/embed/"+videoId+"?"+query;},},{key:"getFacebookUrl",value:function getFacebookUrl(facebook,videoId){return("//www.facebook.com/v2.10/plugins/video.php?href=https://www.facebook.com/facebook/videos/"+
videoId+
"&"+
this.getQueryString(facebook));},},{key:"getHtml",value:function getHtml(opt,videoUrl,id){var padding=this.getPadding(opt.ratio);var classNames=opt.classNames;return('\n      <div class="'+
